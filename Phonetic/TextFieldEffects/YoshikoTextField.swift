...
@IBDesignable public class YoshikoTextField: TextFieldEffects {
     ...
     */
    @IBInspectable public dynamic var activeBorderColor: UIColor = .clearColor() {
        didSet {
            updateBorder()
            updateBackground()
            updatePlaceholder()
    ...
    /**
     ...
     This property applies a color to the edges of the control. The default value for this property is a clear color.
     */
    @IBInspectable public dynamic var inactiveBorderColor: UIColor = .clearColor() {
        didSet {
            updateBorder()
            updateBackground()
            updatePlaceholder()
     ...
     */
    @IBInspectable public dynamic var activeBackgroundColor: UIColor = .clearColor() {
        didSet {
            updateBackground()
        }
    }
     ...
     */
    @IBInspectable public dynamic var placeholderColor: UIColor = .darkGrayColor() {
        didSet {
            updatePlaceholder()
        }
    }
     ...
     */
    @IBInspectable public dynamic var placeholderFontScale: CGFloat = 0.7 {
        didSet {
            updatePlaceholder()
        }
    }
