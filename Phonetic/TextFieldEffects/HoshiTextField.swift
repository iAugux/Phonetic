...
@IBDesignable public class HoshiTextField: TextFieldEffects {
     ...
     */
    @IBInspectable public dynamic var borderInactiveColor: UIColor? {
        didSet {
            updateBorder()
        }
    }
    ...
    /**
     ...
     This property applies a color to the lower edge of the control. The default value for this property is a clear color.
     */
    @IBInspectable public dynamic var borderActiveColor: UIColor? {
        didSet {
            updateBorder()
        }
    }
     ...
     */
    @IBInspectable public dynamic var placeholderColor: UIColor = .blackColor() {
        didSet {
            updatePlaceholder()
        }
    }
     ...
     */
    @IBInspectable public dynamic var placeholderFontScale: CGFloat = 0.65 {
        didSet {
            updatePlaceholder()
        }
    }
